...
sf project generate manifest --name destructiveChangesManifest --metadata DLT_CaseBatch.cls-meta.xml --output-dir "/home/runner/work/SalesforceDevOpsPresentation/SalesforceDevOpsPresentation"
