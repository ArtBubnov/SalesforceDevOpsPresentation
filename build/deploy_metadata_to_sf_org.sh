...
sf project generate manifest --name destructiveChangesManifest --metadata "ApexClass:DLT_CaseBatch.cls-meta.xml,ApexClass:DLT_SubscriptionBatch.cls-meta.xml" --output-dir "/home/runner/work/SalesforceDevOpsPresentation/SalesforceDevOpsPresentation"
