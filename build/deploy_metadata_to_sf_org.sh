...
sfdx force:source:manifest:create --name destructiveChangesManifest --metadata "SVOCUpdateFields.fieldSet-meta.xml,TACTUpdateFields.fieldSet-meta.xml,Business_Account__c.field-meta.xml,Contact_Number__c.field-meta.xml,Customer_Email__c.field-meta.xml,Customer_Opt_In_Type__c.field-meta.xml,DELTA_Loyalty_Member__c.field-meta.xml,Delta_Loyalty_Tier__c.field-meta.xml" -d "/home/runner/work/SalesforceDevOpsPresentation/SalesforceDevOpsPresentation"
echo "LS AFTER"
ls
echo "********"
echo "********"
